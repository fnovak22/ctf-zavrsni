...
- Stack buffer overflow je napad kod kojeg unos veći od rezerviranog momorijskog prostora (buffera) prepiše podatke na stogu (npr. povratnu adresu) i omogućuje napadaču da promijeni tok izvršavanja programa.
